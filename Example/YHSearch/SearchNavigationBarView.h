...
@class SearchNavigationBarView;
@protocol SearchNavigaitonBarViewDelegate <NSObject>

/**
 点击取消按钮
 */
-(void)onClickCancelButtonForSearchNavigaitonBarView:(SearchNavigationBarView*)searchNavigaitonBarView;
...
@property(nonatomic,weak)id<SearchNavigaitonBarViewDelegate>delegate;
